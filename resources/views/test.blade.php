    ...
    <div class="container">
        <div class="row row1">
            <ul class="largenav pull-right">
                ...
                <li class="upper-links dropdown">
                    <a class="links"><span class="glyphicon glyphicon-bell"></span>
                    </a>
                    <ul class="dropdown-menu">
          ...
          @else
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
              ...
              @if (Auth::user()->name=="หทัยชนก อินทนิน")
              <li><a href="{{url('/adduser')}}"><span class="glyphicon glyphicon-plus-sign"></span> เพิ่มผู้ใช้งาน</a></li>
              @endif
        ...
        <div class="row row2">
            <div class="col-sm-2">
                ...
                <a href="{{url('/home1')}}"><img src="{{url('/img/logo4.png')}}" width="100%"></a>
            </div>
...
<div id="mySidenav" class="sidenav">
    <div class="container" style="background-color: #2874f0; padding-top: 10px;">
        <span class="sidenav-heading">KasetFarm</span>
        <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a>
    </div>
    <a href="http://clashhacks.in/">หน้าแรก</a>
    <a href="http://clashhacks.in/">หมวดสินค้า</a>
    <a href="http://clashhacks.in/">คลังสินค้า</a>
    <a href="http://clashhacks.in/">รายการสินค้า</a>
    <a href="http://clashhacks.in/">รายการแจ้งเตือน</a>
</div>
</div>
